...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	The current status of the project is...
		...
		We promptly started work on our requirements document. We met several as a group times during the week to discuss what the requiremets for the project  to be considered a success.
		...
		\subsection{Week 8}
		The final draft of our individual technology review was due this week. We recieved peer review during class and promplty started editing.
		...
		Client verification is not due till next term, however giving these documents to him early gives us more time to impliment any feedback he might have.

		\subsection{Week 11}

		\section{Problems}
			\subsection{Latex Table Of Contents}
				During week 6 we experinced a problem where we could not get our table
