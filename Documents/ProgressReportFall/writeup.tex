...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	The current status of the project is...
		...
		Each of us picked our top choices out of almost 80 projects. We all shared a top choice of the \textit{Winter Is Coming...} project by Victor Hsu. Before being chosen for the project, each of us wrote descriptions for our top five projects.
		\subsection{Week 2}
		\subsection{Week 3}
		\subsection{Week 4}
		\subsection{Week 5}
