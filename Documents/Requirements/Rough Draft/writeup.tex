...
\singlespace
	...
	\section*{Overall Description}
		...
		Version 1.0 will consist of three major parts. The first part will be the programmable LED’s that will be used to light the plants. These will need to be reprogrammable in order to allow new settings.
		...
		Version 2.0 consists of additional features added by our team. Version 2.0 will require everything from Version 1.0 to be completed. This version will add many new features. The first, and most
		...
		Version 3.0 consists of our stretch goals, goals that we will attempt to complete when we are finished with our version 1.0 and 2.0 given we have enough time. This version, like the last version,
