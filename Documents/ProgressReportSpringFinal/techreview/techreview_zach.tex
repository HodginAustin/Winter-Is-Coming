...
<Zone>
  ...
  <PwrState>On</PwrState>
		...
		\includegraphics[width=\linewidth]{techreview/FileManipDiag.png}
		...
		\includegraphics[width=\linewidth]{techreview/IPCDiag.png}
	...
	\section{Control Service data storage}
	  ...
	  The third aspect is speed. The data will be stored on a device with limited processing capabilities. Saving or loading data should not be a bottleneck to system performance.
		...
		\includegraphics[width=\linewidth]{techreview/serializationDiag.png}
...
\end{itemize}
		...
		\includegraphics[width=\linewidth]{techreview/markupDiag.png}
		...
		\section{Control Service internal state}
			...
			\includegraphics[width=\linewidth]{techreview/objectsDiag.png}
