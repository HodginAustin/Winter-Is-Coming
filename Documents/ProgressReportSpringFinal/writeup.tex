...
%\textbf{\textsuperscript{citation needed}}
				\newpage
        \begin{abstract}
				\noindent This paper serves as a final wrap up and summary of the team's project from start to finish. It details what the team assessed as the problem, how the team designed the
				large system components to solve the problem, what technologies were researched to complete the system, and the overall progress made throughout the year. To capture this
				progress, the paper collects each member's weekly blog posts and notes. Since the project is now complete, detailed instructions on how to setup and use the system are included.
				Finally, the document provides each of the team members' retrospective and opinions of the project, and some resources helpful to the reader.
        \end{abstract}
    \end{singlespace}
\end{titlepage}
		...
		\subsection{Austin Hodgin}
			...
			\subsubsection{Spring}
				\begin{itemize}
					...
					\item \textbf{Week 9} - Finished the report and video on Saturday and turned in the video. We were able to make the video only 30 min. We also made the hardware for Victor and were able to make it compact so it is not as crazy with wirers everywhere. 
					\item \textbf{Week 10} -Had the hand off to victor on Friday gave him back his Nano's, the pi zero w and his LED's. We gave him a rundown of how it works and how to re-flash it if things go wrong or something changes and showed him how to use it to add Nano's, LEDS, Daily States, Zones, and how to change them if needed.  
				\end{itemize}
		\subsection{Travis Hodgin}
			\subsubsection{Fall}
				\begin{itemize}
			...
			\subsubsection{Spring}
				\begin{itemize}
					...
					\item \textbf{Week 9} - We got together and compiled all of our hardware. What we bought and what we need to return to Victor. We started work on the final report and presentation. Emailed victor about the project handoff.
					\item \textbf{Week 10} - We finished the presentation and just about finished the final report. All we have to do is insert this last weeks' worth of OneNote into it. Finally got an email back from Victor about the project handoff.  Meeting on Friday at Noon. 
				\end{itemize}
		\subsection{Max Schmidt}
			\subsubsection{Fall}
				\begin{itemize}
