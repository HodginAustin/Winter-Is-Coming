...
%\textbf{\textsuperscript{citation needed}}
        ...
        \begin{abstract}
				...
				large system components to solve the problem, what was researched for the technologies used to complete the system, and the overall progress made throughout the year.  To capture 
				this progress, the paper also collects each member's weekly blog posts and notes. Since the project is now complete, detailed instructions on how to setup and use the system are
				also included.  Finally, the document provides each of the team members' retrospective and opinions of the project.
        \end{abstract}
    \end{singlespace}
\end{titlepage}
