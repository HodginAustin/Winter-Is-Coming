...
void loop(){
	...
	\section{Project Timeline}
		...
		Iteration 2's largest feature is the scripting of the basic LED controls.  A user may run a terminal, text based script to insert values into the control
		service. This will update the LEDs quickly, but will not be user friendly or quick.  This may also be a shortened iteration interval.  The passing of
		data is completed, and a script is now taking over for manual updates.  
